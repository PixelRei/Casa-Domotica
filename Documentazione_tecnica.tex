...
\begin{itemize}
    ...
    \item \textbf{Sicurezza}: WPA2-PSK con cifratura AES
...
\begin{itemize}
    \item \textbf{Sicurezza}: segmentazione logica tramite IP statici, cifratura WPA2, controllo degli accessi.
...
La configurazione del modulo wireless, implementata con cifratura WPA2 e selezione di un canale specifico, ha assicurato un buon livello di sicurezza e stabilità nella comunicazione tra i dispositivi mobili e IoT. Inoltre, la rete è stata progettata per essere estendibile, facilitando l’aggiunta di nuovi nodi domotici senza impattare negativamente sulle performance esistenti.
